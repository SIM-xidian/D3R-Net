...
def restore_rsi(args):
    ...
    pretrained_model = '/home/ymhj/桌面/liuxuehu/zuhui629/weight/UCM/vgg16.pth'
    targetnet = timm.create_model('vgg16', pretrained=False, num_classes=21)
    targetnet.to(device)
...
def parse_args():
    ...
    parser.add_argument("--datapath", type=str, default='/home/ymhj/桌面/liuxuehu/get_adv/UAE-RS/UCM',
                        help='adv rsi path')
    parser.add_argument("--model_weight", type=str,
                        default='/home/ymhj/桌面/liuxuehu/Diffusion_weight/weight/openai-2023-07-07-23-46-33-928071/model120000.pt',
                        help='pretrained weight')
    parser.add_argument("--save", type=str, default='/home/ymhj/桌面/D3RNet/tmp',
